        ...
        <div className="md:col-span-1 space-y-6">
          <div className="bg-[#121212] border border-[#262626] rounded-xl p-6 shadow-xl">
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="h-20 w-20 rounded-full bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center text-2xl font-bold text-emerald-400 mb-4">
                AD
              </div>
              <h4 className="text-white font-medium">Administrator</h4>
              <span className="bg-emerald-500/20 text-emerald-300 text-xs px-2.5 py-1 rounded-full mt-2 font-medium">Admin Role</span>
            </div>
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#1a1a1a] border border-[#333] rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-emerald-500 transition-colors"
                  required
                />
              </div>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 disabled:cursor-not-allowed text-black text-sm font-bold py-2.5 px-6 rounded-lg transition-colors shadow-lg shadow-emerald-950/30"
                >
